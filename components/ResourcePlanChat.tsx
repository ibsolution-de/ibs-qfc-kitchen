  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          {isMinimized && (
            <button 
              type="button"
              className="flex items-center justify-between px-4 h-full w-full hover:bg-charcoal-800 transition-colors text-left"
            ...
            <>
              ...
              <div className="flex-none flex items-center justify-between px-4 py-3 border-b border-charcoal-700 bg-charcoal-950/50 select-none">
                ...
                <div className="flex items-center gap-1">
                   <button onClick={handleOpenSettings} className="p-1.5 text-charcoal-400 hover:text-blue-400 rounded-md transition-colors" aria-label={t('chat.settings')} title={t('chat.settings')}>
                      <Settings className="w-3.5 h-3.5" />
                   </button>
                   <button onClick={() => setIsMinimized(true)} className="p-1.5 text-charcoal-400 hover:text-blue-400 rounded-md transition-colors" aria-label={t('chat.minimize')} title={t('chat.minimize')}>
                      <Minimize2 className="w-3.5 h-3.5" />
                   </button>
                   <button onClick={requestClose} className="p-1.5 text-charcoal-400 hover:text-red-400 rounded-md transition-colors" aria-label={t('chat.close')} title={t('chat.close')}>
                      <X className="w-4 h-4" />
                   </button>
                </div>
              </div>
      ...
      <ConfirmDialog
        ...
        confirmLabel={t('chat.confirmCloseConfirm')}
        cancelLabel={t('chat.confirmCloseCancel')}
        destructive
      />
    </>
  );
